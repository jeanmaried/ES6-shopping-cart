    ...
    if (sessionStorage) {
      for (let key in sessionStorage) {
        if (sessionStorage.hasOwnProperty(key)) {
          ...
          cartItem.innerHTML =
            '<div class="flex padding-bottom-small">' +
            '<div class="small">' +
            '</div>' +
            '<div class="cart_title_spacing">' +
            key +
            '</div>' +
            '</div>' +
            '<div class="flex padding-bottom-small">' +
            '<div class="small">' +
            '</div>' +
            '<input class="cart_title_spacing" id="' +
            key +
            '" type="number" value="' +
            product.quantity +
            '">' +
            ...
            '</div>' +
            '<div class="flex">' +
            '<button class="update" type="button" data-sku="' +
            key +
            '">' +
            'UPDATE' +
            '</button>' +
            '<button class="remove" type="button" data-sku="' +
            key +
            '">' +
            'REMOVE' +
            '</button>' +
